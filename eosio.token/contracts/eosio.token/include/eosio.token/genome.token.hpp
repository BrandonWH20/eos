...
using std::string;
   ...
   class [[eosio::contract("genome.token")]] token : public contract {
      public:
          ...
          * @pre strain name must be original
          * @pre genomehash must be unique
          * @pre genome file must be a link to a vcf file
          */
         [[eosio::action]]
